...
import 'package:eccomerce_app/constants/error_handling.dart';
...
class AdminServices {
  //api service function for posting the products(selling)
  void sellProduct({
  ...
  //api service for getting all the products
